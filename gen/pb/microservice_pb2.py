...
_MARKS_GETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='areasSquarePer100k', full_name='Marks.GetRequest.areasSquarePer100k', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='areasAmountPer100k', full_name='Marks.GetRequest.areasAmountPer100k', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sportsAmountPer100k', full_name='Marks.GetRequest.sportsAmountPer100k', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subwayDistance', full_name='Marks.GetRequest.subwayDistance', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pollutionPercentage', full_name='Marks.GetRequest.pollutionPercentage', index=4,
...
_MARKS_GETRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mark', full_name='Marks.GetResponse.mark', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Marks = _reflection.GeneratedProtocolMessageType('Marks', (_message.Message,), {
  ...
  'GetRequest' : _reflection.GeneratedProtocolMessageType('GetRequest', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:Marks.GetRequest)
    })
  ,
  ...
  'GetResponse' : _reflection.GeneratedProtocolMessageType('GetResponse', (_message.Message,), {
    ...
    '__module__' : 'microservice_pb2'
    # @@protoc_insertion_point(class_scope:Marks.GetResponse)
    })
  ,
  'DESCRIPTOR' : _MARKS,
  '__module__' : 'microservice_pb2'
  # @@protoc_insertion_point(class_scope:Marks)
  })
...
_MICROSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetMark',
    full_name='Microservice.GetMark',
    index=0,
